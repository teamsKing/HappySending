package com.team.happysending.views.widget;
...
public class RecordView extends View {
    ...
    private int countdownTime = 0;//倒计时时间，默认时间10秒
    private int countdownTime2 = 0;//倒计时时间，默认时间10秒.这是会变的
    private float progress = 0;//总进度360
    private boolean canDrawProgress = true;
    private double r;
    ...
    Handler mHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what == 1){
               ...
               progress += 360.00/(9*950.00/5.00);
//                Log.d(TAG,"progress:"+progress);
                if(progress >360){
                    progress = 0;

                    //progress += 360.00/(0*950.00/5.00);
                   // targetVolume = 1;
                    postInvalidate();
                   // progressTask.cancel();
                }else
