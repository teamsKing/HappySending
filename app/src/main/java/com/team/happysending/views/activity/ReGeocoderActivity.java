 ...
 * 地理编码与逆地理编码功能介绍
 */
public class ReGeocoderActivity extends Activity implements OnGeocodeSearchListener, OnMarkerClickListener,AMapLocationListener,Inputtips.InputtipsListener {
...
//第二个参数传入null或者“”代表在全国进行检索，否则按照传入的city进行检索
				...
				String address=add[1].substring(0,4);
				InputtipsQuery inputquery = new InputtipsQuery(address, "北京");
